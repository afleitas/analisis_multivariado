...
# en forma univariada pocas parecieran ser normales, pero esto no implica que conjuntamente no lo sean, como son independientes pareciera ser que 
# conjuntamente tampoco lo serian, hagamos una prueba bivariada
...
- Normalidad en los vectores aleatorios e independencia en las observaciones y variables
